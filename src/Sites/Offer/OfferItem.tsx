...
const OfferItem = () => {
    ...
    const profiles = {
      ...
      teleinformatyk: {
        ...
        desc: [
          "Programowanie (python, bazy danych, usługi www)",
          "Projektować i konfigurować lokalne sieci komputerowe",
          "Projektować i konfigurować rozległe sieci komputerowe",
          "Budować sieci światłowodowe",
          "Konfiguracji urządzenia sieciowe (switch, router, firewall, puntkty dostępowe bezprzewodowe)",
          "Konfiguracji central telefonicznych",
          "administrowania systemami Windows serwer i Usługami Serwerowymi Linux",
        ],
        qualifications: [
          {
            name: "K1 - INF.07",
