        ...
        <>
            <div className={classes.main}>
                ...
                <div className={classes.buttonFlex}>
                    <Button buttonText="Wizytówka ZSEM" icon={<Icon.Youtube/>}
                            onClick={() => {
                                window.location.replace("https://www.youtube.com/watch?v=yG12VjDxQfc")
                            }}/>
                    <Button buttonText="Regulamin rekrutacji" icon={<Icon.DoorClosedFill/>} className="alternate"
                            onClick={() => {
                                window.location.replace("https://zsem.edu.pl/pliki/szkolny_regulamin_rekrutacji_2023.pdf")
                            }}/>
                </div>
