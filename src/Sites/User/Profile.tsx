...
const Profile = () => {
  ...
  const getUserPosts = useCallback(async () => {
    setIsLoading(true);
    try {
      await fetch(`https://${process.env.REACT_APP_REQUEST_URL}/user/${userId}/spottedPosts`, {
        method: "GET",
        credentials: "include",
      })
        .then((res) => res.json())
  ...
  const getPublicInfo = useCallback(
    async function getPublicInfo() {
      setIsLoading(true);
      try {
        await fetch(`https://${process.env.REACT_APP_REQUEST_URL}/user/${userId}`, {
          method: "GET",
          credentials: "include",
        })
          .then((res) => res.json())
  ...
  const followUser = async () => {
    const response = await fetch(`https://${process.env.REACT_APP_REQUEST_URL}/user/follows`, {
      method: "POST",
      headers: {
